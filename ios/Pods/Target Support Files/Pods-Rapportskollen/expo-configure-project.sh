...
with_node \
  ...
  --target "/Users/rubenvillegas/Desktop/React/rapportskollen-app/ios/Pods/Target Support Files/Pods-Rapportskollen/ExpoModulesProvider.swift" \
  --entitlement "/Users/rubenvillegas/Desktop/React/rapportskollen-app/ios/Rapportskollen/Rapportskollen.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-camera" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-local-authentication" "expo-location" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
